...
set o 'iast.png'
set k top left
set title "A and B pure adsorption isotherms in X nanoporous material"
set format x "10^{%L}"
...
set title "A/B binary mixture in X nanoporous material"
plot 'adsorcion.dat' u 1:2 w l lt 1 lc rgb "red" t "A",\
     'adsorcion.dat' u 1:3 w l lt 1 lc rgb "dark-green" t "B",\
     'adsorcion.dat' u 1:($3/$2) axes x1y2 w l lt 1 lc rgb "blue" t "B/A",1.0 axes x1y2 w l lt 2 lc rgb "blue" notitle
unset multiplot
